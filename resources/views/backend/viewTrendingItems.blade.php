		...
		<div class="container">
			<!-- button to go Add new items form -->
                 <div class="form-group button">
						<a href="{{url('/addtrendingItem')}}" class="btn">Add New Data</a>
				 </div><br>
			<div class="row">
				<div class="col-12">
					<!-- Shopping Summery -->
						...
						<tbody>
							...
							<tr>
								...
								<td class="action"data-title="Remove">
                                    <a href="{{'/deleteT/'.$items->T_id}}"><i class="ti-trash remove-icon"></i></a>
                                    <a href="{{'/edittrendingItem/'.$items->T_id}}"><i class=" ti-eye remove-icon"></i></a>
                                </td>
							</tr>
							@endforeach
						</tbody>
